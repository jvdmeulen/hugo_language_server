...
export const MORE_TEMPLATE_SYMBOL_DOCS: Record<
  string,
  { summary: string; usage: string; notes?: string[]; kind: "function" | "object" | "method" }
> = {
  ".Aliases": { kind: "object", summary: "Aliases defined for the current page.", usage: "{{ .Aliases }}" },
  ".AllPages": { kind: "object", summary: "All pages in the site, including list and regular pages.", usage: "{{ range .Site.AllPages }}...{{ end }}" },
  ".AllTranslations": { kind: "object", summary: "All translations of the current page, often including the current language variant.", usage: "{{ range .AllTranslations }}...{{ end }}" },
  ".BaseURL": { kind: "object", summary: "Base URL configured for the site.", usage: "{{ .Site.BaseURL }}" },
  ".BuildDrafts": { kind: "object", summary: "Boolean indicating whether draft content is included in the current build.", usage: "{{ if .Site.BuildDrafts }}...{{ end }}" },
  ".BundleType": { kind: "object", summary: "Bundle type of the current page, such as leaf or branch.", usage: "{{ .BundleType }}" },
  ".CodeOwners": { kind: "object", summary: "Code owners metadata for the current page when available.", usage: "{{ .CodeOwners }}" },
  ".Config": { kind: "object", summary: "Site configuration object.", usage: "{{ .Site.Config.Services }}" },
  ".ContentWithoutSummary": { kind: "object", summary: "Rendered content with the summary section removed.", usage: "{{ .ContentWithoutSummary }}" },
  ".Copyright": { kind: "object", summary: "Copyright string configured for the site.", usage: "{{ .Site.Copyright }}" },
  ".Description": { kind: "object", summary: "Description of the current page or site object.", usage: "{{ .Description }}" },
  ".Dimension": { kind: "object", summary: "Dimensional metadata for image-like resources.", usage: "{{ .Dimension }}" },
  ".Fragments": { kind: "object", summary: "Heading and fragment metadata for the current page.", usage: "{{ .Fragments.Headings }}" },
  ".FuzzyWordCount": { kind: "object", summary: "Approximate word count for the current page.", usage: "{{ .FuzzyWordCount }}" },
  ".GitInfo": { kind: "object", summary: "Git metadata for the current page when Git info is enabled.", usage: "{{ .GitInfo.AuthorDate }}" },
  ".HasChildren": { kind: "object", summary: "Boolean indicating whether a menu entry has child entries.", usage: "{{ if .HasChildren }}...{{ end }}" },
  ".Home": { kind: "object", summary: "The home page object for the current site.", usage: "{{ .Site.Home.Title }}" },
  ".Identifier": { kind: "object", summary: "Identifier of a menu entry or similar object.", usage: "{{ .Identifier }}" },
  ".IsDefault": { kind: "object", summary: "Boolean indicating whether the site or language is the default one.", usage: "{{ if .Site.IsDefault }}...{{ end }}" },
  ".KeyName": { kind: "object", summary: "Normalized key-like name for the current object, often used for menu entries.", usage: "{{ .KeyName }}" },
  ".Keywords": { kind: "object", summary: "Keywords associated with the current page.", usage: "{{ .Keywords }}" },
  ".LanguagePrefix": { kind: "object", summary: "Language prefix used for the current multilingual site.", usage: "{{ .Site.LanguagePrefix }}" },
  ".Layout": { kind: "object", summary: "Resolved layout name for the current page.", usage: "{{ .Layout }}" },
  ".LinkTitle": { kind: "object", summary: "Link-oriented title for the current page or menu entry.", usage: "{{ .LinkTitle }}" },
  ".MainSections": { kind: "object", summary: "Main sections configured for the current site.", usage: "{{ range .Site.MainSections }}...{{ end }}" },
  ".MediaType": { kind: "object", summary: "Media type information for the current output format or resource.", usage: "{{ .MediaType.Type }}" },
  ".Menu": { kind: "object", summary: "Menu identifier or menu object for the current context.", usage: "{{ .Menu }}" },
  ".Menus": { kind: "object", summary: "All site menus.", usage: "{{ range .Site.Menus.main }}...{{ end }}" },
  ".Meta": { kind: "object", summary: "Metadata associated with the current resource.", usage: "{{ .Meta }}" },
  ".NumberOfElements": { kind: "object", summary: "Number of elements on the current pager.", usage: "{{ .Paginator.NumberOfElements }}" },
  ".PageGroups": { kind: "object", summary: "Grouped page buckets returned by paginated/grouped collections.", usage: "{{ range .Paginator.PageGroups }}...{{ end }}" },
  ".PageNumber": { kind: "object", summary: "Current page number of a paginator.", usage: "{{ .Paginator.PageNumber }}" },
  ".PageRef": { kind: "object", summary: "Page reference string associated with a menu entry or link-like object.", usage: "{{ .PageRef }}" },
  ".PagerSize": { kind: "object", summary: "Configured pager size.", usage: "{{ .Paginator.PagerSize }}" },
  ".Pagers": { kind: "object", summary: "All pagers in the paginator sequence.", usage: "{{ range .Paginator.Pagers }}...{{ end }}" },
  ".Path": { kind: "object", summary: "Logical path for the current page or resource.", usage: "{{ .Path }}" },
  ".Plain": { kind: "object", summary: "Plain text version of the current content.", usage: "{{ .Plain }}" },
  ".PlainWords": { kind: "object", summary: "Plain text words extracted from the current content.", usage: "{{ .PlainWords }}" },
  ".Post": { kind: "object", summary: "HTML fragment rendered after a menu entry link.", usage: "{{ .Post }}" },
  ".Pre": { kind: "object", summary: "HTML fragment rendered before a menu entry link.", usage: "{{ .Pre }}" },
  ".RawContent": { kind: "object", summary: "Unrendered source content of the current page.", usage: "{{ .RawContent }}" },
  ".RegularPagesRecursive": { kind: "object", summary: "Regular pages below the current section, recursively.", usage: "{{ range .RegularPagesRecursive }}...{{ end }}" },
  ".Rel": { kind: "object", summary: "Relationship string of an output format.", usage: "{{ .Rel }}" },
  ".ResourceType": { kind: "object", summary: "Resource type such as image, text, or other media categories.", usage: "{{ .ResourceType }}" },
  ".Role": { kind: "object", summary: "Role of the current site in a multilingual setup.", usage: "{{ .Site.Role }}" },
  ".Sitemap": { kind: "object", summary: "Sitemap configuration or sitemap-related metadata.", usage: "{{ .Sitemap.Priority }}" },
  ".Slug": { kind: "object", summary: "Slug of the current page.", usage: "{{ .Slug }}" },
  ".Taxonomies": { kind: "object", summary: "All site taxonomies and their terms.", usage: "{{ .Site.Taxonomies }}" },
  ".TotalNumberOfElements": { kind: "object", summary: "Total item count across the entire paginator.", usage: "{{ .Paginator.TotalNumberOfElements }}" },
  ".TotalPages": { kind: "object", summary: "Total number of pages in the paginator sequence.", usage: "{{ .Paginator.TotalPages }}" },
  ".TranslationKey": { kind: "object", summary: "Translation key connecting multilingual variants of a page.", usage: "{{ .TranslationKey }}" },
  ".Truncated": { kind: "object", summary: "Boolean indicating whether the summary or rendered excerpt is truncated.", usage: "{{ if .Truncated }}...{{ end }}" },
  ".URL": { kind: "object", summary: "Resolved URL for the current object, commonly used on menu entries and output formats.", usage: "{{ .URL }}" },
  ".Version": { kind: "object", summary: "Hugo version or site version object depending on context.", usage: "{{ .Site.Version }}" },
  ".Weight": { kind: "object", summary: "Weight value used for ordering pages or menu entries.", usage: "{{ .Weight }}" },
  ".Width": { kind: "object", summary: "Width of an image resource.", usage: "{{ .Width }}" },
  ".Height": { kind: "object", summary: "Height of an image resource.", usage: "{{ .Height }}" },
  ".Colors": { kind: "object", summary: "Dominant colors extracted from an image resource.", usage: "{{ .Colors }}" },
  ".Exif": { kind: "object", summary: "EXIF metadata for an image resource.", usage: "{{ .Exif.Date }}" },
  ".Eq": { kind: "method", summary: "Compares the current page or object with another for equality.", usage: "{{ if .Eq $other }}...{{ end }}" },
  ".HasMenuCurrent": { kind: "method", summary: "Checks whether a menu entry points at the current page or section.", usage: '{{ if .HasMenuCurrent "main" . }}...{{ end }}' },
  ".HasShortcode": { kind: "method", summary: "Checks whether the current page uses a given shortcode.", usage: '{{ if .HasShortcode "figure" }}...{{ end }}' },
  ".HeadingsFiltered": { kind: "method", summary: "Returns headings filtered by level or other criteria.", usage: "{{ .Fragments.HeadingsFiltered 2 3 }}" },
  ".InSection": { kind: "method", summary: "Checks whether the current page belongs to the given section.", usage: "{{ if .InSection .CurrentSection }}...{{ end }}" },
  ".IsAncestor": { kind: "method", summary: "Checks whether the current page is an ancestor of another page.", usage: "{{ if .IsAncestor $page }}...{{ end }}" },
  ".IsDescendant": { kind: "method", summary: "Checks whether the current page is a descendant of another page.", usage: "{{ if .IsDescendant $section }}...{{ end }}" },
  ".IsMenuCurrent": { kind: "method", summary: "Checks whether a menu entry is the current one for a page.", usage: '{{ if .IsMenuCurrent "main" . }}...{{ end }}' },
  ".Ref": { kind: "method", summary: "Builds an absolute internal reference from the current page context.", usage: '{{ .Ref "docs/start-here" }}' },
  ".RelRef": { kind: "method", summary: "Builds a relative internal reference from the current page context.", usage: '{{ .RelRef "docs/start-here" }}' },
  ".RenderShortcodes": { kind: "method", summary: "Renders shortcodes in a content fragment without rendering the full page.", usage: "{{ .RenderShortcodes }}" },
  ".RenderString": { kind: "method", summary: "Renders a Markdown or text fragment in the current page context.", usage: '{{ .RenderString "**Hello**" }}' },
  ".Paginator": { kind: "method", summary: "Returns a paginator for the current page collection.", usage: "{{ $p := .Paginator }}" },
  ".ByDate": { kind: "method", summary: "Sorts a page collection by date.", usage: "{{ range .Pages.ByDate }}...{{ end }}" },
  ".ByExpiryDate": { kind: "method", summary: "Sorts a page collection by expiry date.", usage: "{{ range .Pages.ByExpiryDate }}...{{ end }}" },
  ".ByLanguage": { kind: "method", summary: "Sorts a page collection by language.", usage: "{{ range .Pages.ByLanguage }}...{{ end }}" },
  ".ByLastmod": { kind: "method", summary: "Sorts a page collection by last modification date.", usage: "{{ range .Pages.ByLastmod }}...{{ end }}" },
  ".ByLength": { kind: "method", summary: "Sorts a page collection by content length.", usage: "{{ range .Pages.ByLength }}...{{ end }}" },
  ".ByLinkTitle": { kind: "method", summary: "Sorts a page collection by link title.", usage: "{{ range .Pages.ByLinkTitle }}...{{ end }}" },
  ".ByParam": { kind: "method", summary: "Sorts a page collection by a front matter param.", usage: '{{ range (.Pages.ByParam "weight") }}...{{ end }}' },
  ".ByPublishDate": { kind: "method", summary: "Sorts a page collection by publish date.", usage: "{{ range .Pages.ByPublishDate }}...{{ end }}" },
  ".ByTitle": { kind: "method", summary: "Sorts a page collection by title.", usage: "{{ range .Pages.ByTitle }}...{{ end }}" },
  ".ByWeight": { kind: "method", summary: "Sorts a page collection by weight.", usage: "{{ range .Pages.ByWeight }}...{{ end }}" },
  ".GroupBy": { kind: "method", summary: "Groups a page collection by a field.", usage: '{{ range (.Pages.GroupBy "Section") }}...{{ end }}' },
  ".GroupByDate": { kind: "method", summary: "Groups a page collection by date.", usage: "{{ range .Pages.GroupByDate \"2006\" }}...{{ end }}" },
  ".GroupByExpiryDate": { kind: "method", summary: "Groups a page collection by expiry date.", usage: "{{ range .Pages.GroupByExpiryDate \"2006\" }}...{{ end }}" },
  ".GroupByLastmod": { kind: "method", summary: "Groups a page collection by last modification date.", usage: "{{ range .Pages.GroupByLastmod \"2006\" }}...{{ end }}" },
  ".GroupByParam": { kind: "method", summary: "Groups a page collection by a parameter.", usage: '{{ range (.Pages.GroupByParam "series") }}...{{ end }}' },
  ".GroupByParamDate": { kind: "method", summary: "Groups a page collection by a date parameter.", usage: '{{ range (.Pages.GroupByParamDate "eventDate" "2006") }}...{{ end }}' },
  ".GroupByPublishDate": { kind: "method", summary: "Groups a page collection by publish date.", usage: "{{ range .Pages.GroupByPublishDate \"2006\" }}...{{ end }}" },
  ".Limit": { kind: "method", summary: "Returns the first N items from a page collection.", usage: "{{ range (.Pages.Limit 5) }}...{{ end }}" },
  ".Related": { kind: "method", summary: "Returns pages related to the current page.", usage: "{{ range .Site.RegularPages.Related . }}...{{ end }}" },
  ".Reverse": { kind: "method", summary: "Reverses the order of a collection.", usage: "{{ range .Pages.Reverse }}...{{ end }}" },
  ".Crop": { kind: "method", summary: "Crops an image resource.", usage: '{{ (.Resources.GetMatch "hero.*").Crop "800x400" }}' },
  ".Fill": { kind: "method", summary: "Resizes and crops an image resource to fill dimensions.", usage: '{{ (.Resources.GetMatch "hero.*").Fill "800x400" }}' },
  ".Filter": { kind: "method", summary: "Applies one or more image or resource filters.", usage: "{{ $img.Filter images.GaussianBlur }}" },
  ".Fit": { kind: "method", summary: "Fits an image resource within dimensions while preserving aspect ratio.", usage: '{{ (.Resources.GetMatch "hero.*").Fit "800x400" }}' },
  ".Process": { kind: "method", summary: "Processes a resource with a transformation specification.", usage: '{{ $img.Process "resize 800x" }}' },
  ".Publish": { kind: "method", summary: "Publishes a resource and returns the published resource.", usage: "{{ $resource.Publish }}" },
  ".Resize": { kind: "method", summary: "Resizes an image resource.", usage: '{{ (.Resources.GetMatch "hero.*").Resize "800x" }}' },
  ".Get": { kind: "method", summary: "Context-sensitive getter used by some Hugo objects such as taxonomies, output formats, and shortcode contexts.", usage: '{{ .Get "key" }}' },
  ".Page": { kind: "method", summary: "Returns the page associated with the current object, such as a taxonomy term or menu entry.", usage: "{{ with .Page }}{{ .Title }}{{ end }}" },
};
